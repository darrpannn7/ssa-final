...
```ts
  ...
  270 |     console.log(`[FC-001] Plotly chart visible. Legend items: ${count}`);
  271 |     expect(count).toBeGreaterThanOrEqual(1);
  272 |   });
  273 | 
  274 |   test("FC-002: GOES chart Y-axis is shown (log type verified visually)", async ({ page }) => {
